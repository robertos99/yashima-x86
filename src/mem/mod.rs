...
/// Returns the processors supported physical address size and current virtual address size as (phys_range, virt_range)
///
/// [source](https://www.felixcloutier.com/x86/cpuid)
///
/// * EAX Linear/Physical Address size. Bits 07-00: #Physical Address Bits*. Bits 15-08: #Linear Address Bits. Bits 31-16: Reserved = 0.
